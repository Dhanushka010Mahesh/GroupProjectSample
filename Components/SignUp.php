<div class="popup-contentLog  bg-white rounded-xl shadow-lg ">
    <div class="p-10 space-y-4">
        ...
        <form class="space-y-4 md:space-y-6" method="POST" action="Components/AccountDataSend.php">
            ...
            <button type="submit" name="submitACC" class="w-full text-white bg-gray-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign Up</button>
